...
import xyd.com.bydshop.utils.AppUtils;
    ...
    private class NotificationUpdaterThread extends Thread {
        ...
        public void run() {
            while (true) {
                ...
                Log.e("progress","正在下载更新" + progress + "%");
                try {
                    Thread.sleep(1000);
...
//        notificationBuilder.setContentIntent(contentIntent);  // The intent to send when the entry is clicked
    ...
    public void doCheckUpdateTask() {
        final int currentBuild = AppUtils.getAppVersionCode(this);
...
//                    @Override
//                    protected void onHandleSuccess(VersionUpdateModel versionUpdateModel) {
//                        try {
//
...
//                });
    ...
    public void doDownLoadTask() {
        ...
        DownloadUtil.get().download("https://qd.myapp.com/myapp/qqteam/AndroidQQ/mobileqq_android.apk", "download", new DownloadUtil.OnDownloadListener() {
            @Override
    ...
    public void installApk(File file, Context context) {
        ...
        if(Build.VERSION.SDK_INT>=24) { //判读版本是否在7.0以上
            ...
            Uri apkUri =
                    FileProvider.getUriForFile(context, "xyd.com.bydshop.provider", file);
