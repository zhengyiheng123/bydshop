...
public class ZXLRecyclerView extends RecyclerView {
    ...
    public ZXLRecyclerView(Context context) {
        this(context, null);
    }

    public ZXLRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZXLRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    ZXLRecyclerView.this.setVisibility(View.GONE);
                } else {

                    mEmptyView.setVisibility(View.GONE);
                    ZXLRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
