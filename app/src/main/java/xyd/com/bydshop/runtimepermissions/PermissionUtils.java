package xyd.com.bydshop.runtimepermissions;
...
//        void onDenied();
    ...
    private static void requestPermission(final Activity activity, String permission, final OnPermissionResult callback){
        Log.d("*-*", "requesting");
        //流氓读写权限....................
        pm.requestPermissionsIfNecessaryForResult(activity, new String[]{permission, Manifest.permission.WRITE_EXTERNAL_STORAGE}, new PermissionsResultAction() {
            @Override
