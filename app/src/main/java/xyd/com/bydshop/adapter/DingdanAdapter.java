...
public class DingdanAdapter extends RecyclerView.Adapter<DingdanAdapter.ViewHolder> {
    ...
    private List<OrderModel.OrdersBean> list;
    ...
    public DingdanAdapter(Context context, List<OrderModel.OrdersBean> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemDingdanTvNeirong.setText("预定内容：" + list.get(position).getMeal_name());
        holder.itemDingdanTvRenshu.setText("用餐人数：" + list.get(position).getSeat_cost() + "人");
        holder.itemDingdanTvZongji.setText("总计：" + list.get(position).getPrice() + "元");
        holder.itemDingdanTvTime.setText(TimeUtils.millis2String((long) list.get(position).getBook_time() * 1000));
        ...
        holder.dingdanLl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityFactory.goCanyiDetail(context, b);
            }
        });
